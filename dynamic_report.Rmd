...
#Dynamic Comment 1
dynamcom1 <- paste("The most popular drink on campus is", top_drink$type_today, "with", top_drink$n, "logged purchases. This drink is most popularly purchased in the", popular_time$type_today, "with the most common reason being", common_reason$reason, ". These connecting social factors can be taken into context for better analysis and reasoning.")
